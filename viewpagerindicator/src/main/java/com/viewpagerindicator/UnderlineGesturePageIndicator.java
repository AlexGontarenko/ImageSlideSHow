...
public class UnderlineGesturePageIndicator extends View implements PageIndicator {
    ...
    public UnderlineGesturePageIndicator(Context context) {
        this(context, null);
    }

    public UnderlineGesturePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiUnderlinePageIndicatorStyle);
    }

    public UnderlineGesturePageIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (mViewPager != null) {
            ...
            mViewPager.setOnPageChangePageIndicatorListener(null);//.setOnPageChangeListener(null);
        }
        if (viewPager.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have adapter instance.");
        }
        mViewPager = (GestureViewPager) viewPager;
        mViewPager.setOnPageChangePageIndicatorListener(this);//setOnPageChangeListener(this);
        invalidate();
        post(new Runnable() {
            @Override public void run() {
                if (mFades) {
